...
namespace TDD.Tests
{
    ...
    {
        [TestMethod()]
        public void QuickSortSort_Tests1()//checking if the sort works !
        {
            //Arragne
            ...
            Book[] sortedBooks = bookstest.getALL();
            //assert
            Assert.AreEqual(sortedBooks[0], new_book4);
            Assert.AreEqual(sortedBooks[1], new_book3);
        }

        [TestMethod()]
        public void QuickSortSort_Tests()//Checking if the the list is empty and quicksort doesn't added stuff.
        {
            Book_list bookstest = new Book_list();
            bookstest.Sort();


            Assert.AreEqual(0, bookstest.getSize());
        }

        [TestMethod()]
        public void SortSort_Tests() //not removing items
        {
            //Arragne
...
//Bubble sort Testing , before doing TDD, and making a better sort.
